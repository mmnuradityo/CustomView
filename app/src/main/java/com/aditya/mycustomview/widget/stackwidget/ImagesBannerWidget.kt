package com.aditya.mycustomview.widget.stackwidget
...
class ImagesBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.aditya.mycustomview.widget.stackwidget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.aditya.mycustomview.widget.stackwidget.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        intent?.let {
            if (it.action == TOAST_ACTION) {
                val viewIndex = it.getIntExtra(EXTRA_ITEM, 0)
